...
res = data1.get("soapenv:Envelope").get("SOAP-ENV:Body").get("ns0:verificationResponse").get("ns0:message").get("ns2:services_response").get("ns2:bank_account")
print(res)
...
# my_key = 'soapenv:Envelope' #'ns2:bank_account'

# def deep_get(dictionary, *keys):
#     return reduce(lambda d, key: d.get(key, None) if isinstance(d, dict) else None, keys, dictionary)

# res = deep_get(data1,my_key)
